...
```{r histogram of steps per day, echo=TRUE, fig.height=6, fig.width=6}
...
```{r interval average, echo=TRUE, fig.height=6, fig.width=6}
...
```{r imputed steps by data histogram, echo=TRUE, fig.height=6, fig.width=6}
...
```{r, create weekday and weekend panel plot, echo=TRUE, fig.height=6, fig.width=6}
