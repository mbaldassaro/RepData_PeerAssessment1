...
```{r histogram of steps per day, echo=TRUE, results="asis"}
...
```{r interval average, echo=TRUE, results="asis"}
...
```{r imputed steps by data histogram, echo=TRUE, results="asis"}
...
```{r, create weekday and weekend panel plot, echo=TRUE, results="asis"}
